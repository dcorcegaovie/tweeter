...
func TestCanPublishAndRetrieveMoreThanOneTweet(t *testing.T) {
	...
	var tweet, secondTweet domain.PrintableTweet
...
func TestCanCountTheTweetsSentByAnUser(t *testing.T) {
	...
	var tweet, secondTweet, thirdTweet domain.PrintableTweet
...
func isValidTweet(t *testing.T, tweet domain.PrintableTweet, id int, user, text string) bool {
